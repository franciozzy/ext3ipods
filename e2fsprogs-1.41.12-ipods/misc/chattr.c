 ...
 * 11/11/27     - ext3ipods extensions (Felipe Franciosi)
 */
...
{
	fprintf(stderr,
		_("Usage: %s [-RVf] [-+=AacDdijsSu] [-+=WwPpLl] [-v version] files...\n"),
		program_name);
	exit(1);
}
...
//	{ EXT4_EXTENTS_FL, 'e'},
	...
	{ EXT2_NOTAIL_FL, 't' },
	{ EXT2_TOPDIR_FL, 'T' },
	{ EXT3IPODS_HWPRF_FL, 'W' }, // ext3ipods high write performance
	{ EXT3IPODS_MWPRF_FL, 'w' }, // ext3ipods medium write performance
	{ EXT3IPODS_HRPRF_FL, 'P' }, // ext3ipods high read performance
	{ EXT3IPODS_MRPRF_FL, 'p' }, // ext3ipods medium read performance
	{ EXT3IPODS_HRELI_FL, 'L' }, // ext3ipods high reliability
	{ EXT3IPODS_MRELI_FL, 'l' }, // ext3ipods medium reliability
	{ 0, 0 }
};
