...
// IPODS Modifications: the below has been adjusted in order for e2fsprogs to
// compile, but ext4 specific functionalities were disabled in the source code.
#define EXT4_HUGE_FILE_FL               0x08000000 /* Set to each huge file */
#define EXT4_EXTENTS_FL 		0x08000000 /* Inode uses extents */
#define EXT4_EA_INODE_FL	        0x08000000 /* Inode used for large EA */
#define EXT4_EOFBLOCKS_FL		0x08000000 /* Blocks allocated beyond EOF */
#define EXT4_SNAPFILE_FL		0x08000000  /* Inode is a snapshot */
#define EXT4_SNAPFILE_DELETED_FL	0x08000000  /* Snapshot is being deleted */
#define EXT4_SNAPFILE_SHRUNK_FL		0x08000000  /* Snapshot shrink has completed */

/* QoS specific flags */
#define	EXT3IPODS_MWPRF_FL		0x00100000 /* Medium write performance */
#define	EXT3IPODS_HWPRF_FL		0x00200000 /* High write performance */
#define	EXT3IPODS_MRPRF_FL		0x00400000 /* Medium read performance */
#define	EXT3IPODS_HRPRF_FL		0x00800000 /* High read performance */
#define	EXT3IPODS_MRELI_FL		0x01000000 /* Medium reliability */
#define	EXT3IPODS_HRELI_FL		0x02000000 /* High reliability */

#define EXT2_RESERVED_FL		0x80000000 /* reserved for ext2 lib */

#define EXT2_FL_USER_VISIBLE		0x03F3DFFF /* User visible flags */
#define EXT2_FL_USER_MODIFIABLE		0x03F380FF /* User modifiable flags */
